...
""" 
VINI: Tirei isto da definição da Main, E comentei as linhas 119,120,127,128
...
def main(isPlotting = False, seed = 10,
    ...
    return historico, X_cinco_params, round(end-start, 3)
